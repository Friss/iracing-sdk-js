...
namespace NodeIrSdk
{
    ...
    const std::vector<MaskName> PACE_MODE = {
        MaskName((int)irsdk_PaceModeSingleFileStart, "PaceModeSingleFile"),
        MaskName((int)irsdk_PaceModeDoubleFileStart, "PaceModeDoubleFile"),
    ...
    const std::vector<MaskName> PACE_FLAGS = {
        MaskName((int)irsdk_PaceFlagsEndOfLine, "PaceFlagsEndOfLine"),
